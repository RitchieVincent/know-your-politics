    ...
    $(".partyBtn").click(function (e) {
        ...
        function resultDisplay() {
            ...
            if (choiceClass == "labourChoice") {
                ...
                $(".scoreNumber").html("<p>You scored " + finalPercent + "% of the Labour questions correct.</p>"); //Displays the percent correct to the user
            ...
            if (choiceClass == "conservativeChoice") {
                ...
                $(".scoreNumber").html("<p>You scored " + finalPercent + "% of the Conservative questions correct.</p>");
                $(".scoreNumber").append("<p>Your overall score is: " + userScore + "</p>");
            }
            if (choiceClass == "libdemChoice") {
                ...
                $(".scoreNumber").html("<p>You scored " + finalPercent + "% of the Liberal Democrat questions correct.</p>");
                $(".scoreNumber").append("<p>Your overall score is: " + userScore + "</p>");
            }
            if (choiceClass == "ukipChoice") {
                ...
                finalPercent = finalPercent.toFixed();
                zeroCheck(ukipCount);
                $(".scoreNumber").html("<p>You scored " + finalPercent + "% of the UKIP questions correct.</p>");
                $(".scoreNumber").append("<p>Your overall score is: " + userScore + "</p>");
            }
        }
